    ...
    this.innerHTML = `
        ...
        <div class="sidebar-sticky pb-5">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link text-purple active" href="/">
            ...
            <li class="nav-item">
              ...
              <ul class="nav collapse" id="agenciasSubmenu">
                <li class="nav-item pl-3">
                  <a class="nav-link text-secondary" href="/agencias/lista/">
                    <i class="0"></i>
                    Lista de Unidades
                  </a>
                </li>
                ...
                <li class="nav-item pl-3">
                  <a class="nav-link text-secondary" href="/agencias/bloquear/">
                    <i class="0"></i>
                    Bloquear unidade
                  </a>
                </li>
